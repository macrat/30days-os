...
extern void draw_image(uint_fast16_t x, uint_fast16_t y, uint_fast16_t width, uint_fast16_t height, uint8_t *image);
extern void draw_mouse_cursor(uint_fast16_t x, uint_fast16_t y);
