...
#define ADDR_IDT      ((struct GateDescriptor*)0x0026f800)
#define LIMIT_IDT     ((int)0x7ff)
#define ADDR_GDT      ((struct SegmentDescriptor*)0x00270000)
...
void init_gdt() {
    struct SegmentDescriptor *gdt = ADDR_GDT;
...
void init_idt() {
    struct GateDescriptor *idt = ADDR_IDT;
