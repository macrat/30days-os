...
extern void draw_char(int x, int y, char character, const uint8_t *font, uint8_t color);
extern void draw_text(int x, int y, char *text, const uint8_t *font, uint8_t color);
extern void draw_int(int x, int y, int value, int radix, const uint8_t *font, uint8_t color);
extern void draw_image(int x, int y, int width, int height, uint8_t *image);
