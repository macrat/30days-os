...
#define SCREEN_REFRESH_RATE  (SECOND/60)
...
static void refresh_screen_timer(void* ptr) {
    refresh_screen();
    set_timeout(refresh_screen_timer, ptr, SCREEN_REFRESH_RATE);
}
...
int init_screen() {
    ...
    set_timeout(refresh_screen_timer, 0, SCREEN_REFRESH_RATE);
