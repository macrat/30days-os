...
#define AR_TSS32      ((uint16_t)0x0089)
...
void set_task_segment(uint16_t selector, task_status_segment_t* tss) {
    set_segmdesc(ADDR_GDT + selector, 103, (uint32_t)tss, AR_TSS32);
}
